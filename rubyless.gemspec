...
ruby, eventually rewriting some variables or methods.}
  ...
  s.files = ["History.txt", "README.txt", "Rakefile", "rubyless.gemspec", "lib/ruby_less", "lib/ruby_less/basic_types.rb", "lib/ruby_less/error.rb", "lib/ruby_less/no_method_error.rb", "lib/ruby_less/processor.rb", "lib/ruby_less/safe_class.rb", "lib/ruby_less/syntax_error.rb", "lib/ruby_less/typed_string.rb", "lib/ruby_less.rb", "lib/rubyless.rb", "test/mock", "test/mock/active_record_mock.rb", "test/mock/dummy_class.rb", "test/mock/dummy_module.rb", "test/RubyLess", "test/RubyLess/active_record.yml", "test/RubyLess/basic.yml", "test/RubyLess/errors.yml", "test/RubyLess_test.rb", "test/test_helper.rb"]
